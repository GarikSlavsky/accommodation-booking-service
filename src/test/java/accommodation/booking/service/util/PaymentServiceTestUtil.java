...
public class PaymentServiceTestUtil {
    ...
    public User initializeUser(Role role) {
        User user = new User();
        user.setId(VALID_ID);
    ...
    public Booking initializeBooking(User user) {
    ...
    public Accommodation initializeAccommodation() {
    ...
    public Payment initializePayment(Booking booking) {
    ...
    public PaymentResponseDto initializePaymentResponseDto(Payment payment) {
    ...
    public Session initializeStripeSession() {
